...
def main():
    file_path = r"d:\WEB DESIGN\LayananDokumen\components\templates\cuti-karyawan\index.tsx"
...
function CutiBuilder() {
  ...
  const DocumentContent = () => (
    <Kertas>
      ...
      {/* IDENTITAS */}
      <div className="pl-4 space-y-4 mb-8">
      ...
      <div className="mb-12 text-justify">
          <p className="leading-loose">
              Selama masa cuti tersebut, tugas dan tanggung jawab pekerjaan saya akan diserahterimakan (handover) sementara kepada <strong>Sdr/i. {data.namaPengganti.toUpperCase()}</strong>.
          </p>
      ...
      <div className="mt-8 break-inside-avoid">
         <div className="flex justify-between text-center items-stretch mb-8">
            <div className="w-[45%] flex flex-col justify-between">
               <p className="mb-2">&nbsp;</p>
               <p className="font-bold mb-4 uppercase">Pemohon,</p>
               <div className="h-24"></div>
               <p className="font-bold uppercase underline">{data.namaKaryawan}</p>
            </div>
            <div className="w-[45%] flex flex-col justify-between">
               ...
               <div className="h-24"></div>
               <p className="font-bold uppercase underline">{data.namaAtasan}</p>
            </div>
         </div>
         <div className="flex justify-center text-center items-stretch pt-4">
            <div className="w-[45%] flex flex-col justify-between">
               <p className="font-bold mb-4 uppercase">Mengetahui,<br/>HR Department</p>
               <div className="h-24"></div>
               <p className="font-bold uppercase underline">{data.namaHRD}</p>
            </div>
         </div>
      </div>
    </Kertas>
