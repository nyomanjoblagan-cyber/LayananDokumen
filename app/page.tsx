  ...
  const DIRECTORY = [
    {
      ...
      items: [
        ...
        { name: "Surat Keterangan Penghasilan", href: "/tools/keterangan-penghasilan" },
        { name: "Surat Penagihan (Debt)", href: "/tools/penagihan" },
        { name: "Surat Perintah Kerja (SPK)", href: "/tools/spk" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Surat Izin Orang Tua / Suami", href: "/tools/izin-ortu" },
        { name: "CV Maker (ATS)", href: "/tools/cv" },
        { name: "Surat Kontrak Kerja (PKWT)", href: "/tools/kontrak-kerja" },
        { name: "Surat Tugas Dinas", href: "/tools/surat-tugas" },
        { name: "Surat Peringatan (SP)", href: "/tools/sp-karyawan" },
        { name: "Surat Keterangan Kerja / Paklaring", href: "/tools/paklaring" },
        { name: "Surat Resign / Pengunduran Diri", href: "/tools/resign" },
        { name: "Pakta Integritas / NDA", href: "/tools/nda" },
        { name: "Surat Rekomendasi Kerja", href: "/tools/rekomendasi" },
        { name: "Surat Keterangan Bebas Narkoba", href: "/tools/bebas-narkoba" },
        { name: "Surat Pernyataan Tidak Terikat Kerja", href: "/tools/pernyataan-kerja" },
        { name: "Surat Izin Cuti/Hamil/Sakit", href: "/tools/cuti-karyawan" },
        { name: "Surat Pernyataan Tidak Menikah", href: "/tools/belum-nikah-hrd" },
        { name: "Surat Pemberitahuan PHK", href: "/tools/phk" },
        { name: "Surat Rekomendasi Promosi Jabatan", href: "/tools/promosi" },
      ]
    },
    {
      group: "Legal & Aset",
      ...
      items: [
        ...
        { name: "Surat Perjanjian Hutang", href: "/tools/hutang" },
        ...
        { name: "Surat Perjanjian Sewa Kendaraan", href: "/tools/sewa-kendaraan" },
        { name: "Surat Wasiat Sederhana", href: "/tools/wasiat" },
        { name: "Surat Perjanjian Joint Venture", href: "/tools/joint-venture" },
        { name: "Surat Kuasa Urus Pajak", href: "/tools/kuasa-pajak" },
        { name: "Surat Perjanjian Franchise", href: "/tools/franchise" },
      ]
    },
    {
      ...
      items: [
        ...
        { name: "Surat Keterangan Domisili", href: "/tools/domisili" },
        { name: "Surat Keterangan Tidak Mampu", href: "/tools/sktm" },
        { name: "Surat Keterangan Belum Menikah", href: "/tools/belum-menikah" },
        { name: "Surat Izin Keramaian", href: "/tools/izin-keramaian" },
        { name: "Surat Kehilangan", href: "/tools/pernyataan-kehilangan" },
        { name: "Surat Pernyataan Beda Nama", href: "/tools/beda-nama" },
        { name: "Surat Pernyataan Belum Punya Rumah", href: "/tools/belum-punya-rumah" },
        { name: "Surat Keterangan Kematian", href: "/tools/kematian" },
        { name: "Surat Keterangan Penghasilan Orang Tua", href: "/tools/penghasilan-ortu" },
        { name: "Surat Pernyataan Ahli Waris", href: "/tools/ahli-waris-desa" },
        { name: "Surat Pengantar Nikah", href: "/tools/nikah" },
        { name: "Surat Keterangan Tidak Terima Bantuan", href: "/tools/sk-non-bantuan" },
        { name: "Surat IMB Sederhana", href: "/tools/imb" },
        { name: "Surat Pernyataan Tanah Aman", href: "/tools/tanah-aman" },
      ]
    },
    {
      ...
      items: [
        ...
        { name: "Surat Permohonan Redelivery", href: "/tools/redelivery" },
        { name: "Surat Pernyataan Hilang Kirim", href: "/tools/hilang-kirim" },
      ]
    },
    {
      group: "Akademik & Izin",
      ...
      items: [
        ...
        { name: "Surat Permohonan Magang", href: "/tools/magang" },
        { name: "Surat Pernyataan Ortu", href: "/tools/pernyataan-ortu" },
        { name: "Surat Izin Pasangan", href: "/tools/izin-pasangan" },
        { name: "Surat Sponsor Visa", href: "/tools/sponsor-visa" },
        { name: "Ijazah Sementara (Surat Keterangan Lulus)", href: "/tools/skl" },
        { name: "Surat Undur Diri Sekolah/Kuliah", href: "/tools/resign-akademik" },
        { name: "Surat Permohonan Cuti Kuliah", href: "/tools/cuti-kuliah" },
        { name: "Surat Rekomendasi Dosen/Kepsek", href: "/tools/rekomendasi-akademik" },
        { name: "Surat Pernyataan Tidak Studi", href: "/tools/stop-studi" },
        { name: "Surat Permohonan Penelitian", href: "/tools/penelitian" },
      ]
    },
    {
      group: "Kesehatan",
      ...
      items: [
        ...
        { name: "Surat Keterangan Dokter Sederhana", href: "/tools/ket-dokter" },
        { name: "Surat Donor Darah/Organ", href: "/tools/donor" },
      ]
    },
    {
      group: "Event & Acara",
