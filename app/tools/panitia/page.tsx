...
import { 
  ...
  CalendarDays, ClipboardCheck, Info, Edit3, Eye, Check, LayoutTemplate, ChevronDown
} from 'lucide-react';
...
function StatementBuilder() {
  ...
  const StatementContent = () => (
    <div className="bg-white flex flex-col box-border font-serif text-slate-900 leading-relaxed text-[11pt] p-[20mm] w-[210mm] min-h-[296mm] print:min-h-0 print:h-auto shadow-2xl print:shadow-none print:m-0">
      ...
      {/* TANDA TANGAN (Flow Normal dengan mt-auto) */}
