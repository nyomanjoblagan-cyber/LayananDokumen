...
function ResignToolBuilder() {
  ...
  const DocumentContent = () => {
    ...
    return (
      <div className={`bg-white flex flex-col box-border text-slate-900 leading-relaxed p-[20mm] print:p-0 w-[210mm] min-h-[296mm] shadow-2xl print:shadow-none print:m-0 mx-auto ${templateId === 1 ? 'font-serif text-[11pt]' : 'font-sans text-[10.5pt]'}`}>
