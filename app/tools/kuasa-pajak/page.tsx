 ...
 * DESC: Generator Surat Kuasa Khusus Pajak (Format DJP)
 * FEATURES:
 * - Dual Template (Standard vs Corporate)
 * - Auto Date Logic
 * - Mobile Menu Fixed
...
function TaxProxyBuilder() {
  ...
  const ProxyContent = () => (
    // FIX: Print Padding
    <div className="bg-white flex flex-col box-border font-serif text-slate-900 leading-normal text-[11pt] p-[25mm] print:p-[25mm] w-[210mm] min-h-[296mm] shadow-2xl print:shadow-none print:m-0 mx-auto">
