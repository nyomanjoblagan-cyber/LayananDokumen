...
import { 
  ...
  Landmark, UserCircle2, Map, CalendarDays, Receipt, FileText, BadgeCheck, Edit3, Eye
} from 'lucide-react';
    ...
    <div className="bg-white flex flex-col box-border font-serif text-slate-900 leading-relaxed text-[11pt] p-[25mm] w-[210mm] min-h-[296mm] shadow-2xl print:shadow-none print:m-0">
                ...
                <div className="space-y-6">
                   ...
                   <div className="bg-slate-50 p-6 rounded-xl border border-slate-200 space-y-3 print:bg-transparent print:border-black">
                      ...
                      <div className="grid grid-cols-[160px_10px_1fr] text-sm gap-y-1">
                        <span>Nama Wajib Pajak</span><span>:</span><span className="font-bold">{data.wpName}</span>
        ...
        {templateId === 2 && (
            <div className="flex flex-col h-full font-sans text-sm">
                <div className="text-center border-b-2 border-dashed border-slate-400 pb-4 mb-6 print:border-black">
                ...
                <div className="text-center text-xs mt-auto pt-6 border-t border-slate-200 print:border-black">
