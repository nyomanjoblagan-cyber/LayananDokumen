...
import { 
  ...
  ChevronDown, Check, GraduationCap, Briefcase, Edit3, Eye
} from 'lucide-react';'use client';

/**
 * FILE: CoverLetterPage.tsx
 * STATUS: FINAL & MOBILE READY
 * DESC: Generator Surat Lamaran Kerja (Cover Letter)
 * FEATURES:
 * - Dual Template (Formal vs Modern)
 * - Auto Text Presets (Fresh Grad, Pro, Intern)
 * - Auto Date Logic
 * - Mobile Menu Fixed
            ...
            <div className="flex-1 overflow-y-auto w-full flex justify-center p-4 md:p-8 custom-scrollbar">
               <div className="origin-top transition-transform duration-300 transform scale-[0.55] md:scale-[0.85] lg:scale-100 mb-[-130mm] md:mb-[-20mm] lg:mb-0 shadow-2xl flex flex-col items-center">
                 <div style={{ width: '210mm', minHeight: '297mm' }} className="bg-white flex flex-col">
                   {/* FIX: Removed duplicate padding/wrapper */}
                   <LetterContent />
                 </div>
               </div>
            </div>
...
function CoverLetterBuilder() {
  ...
  // --- KOMPONEN ISI SURAT ---
  const LetterContent = () => (
    // PERBAIKAN: Padding 20mm & leading-normal agar muat 1 halaman
    <div className="bg-white flex flex-col box-border font-serif text-slate-900 leading-normal text-[11pt] p-[20mm] w-[210mm] min-h-[296mm] shadow-2xl print:shadow-none print:m-0">
      ...
      {templateId === 2 && (
        <div className="font-sans text-[10.5pt] leading-normal flex flex-col h-full">
            ...
            <div className="mb-8 shrink-0">
                <div className="text-xs text-slate-400 uppercase tracking-widest mb-1">{isClient && data.date ? new Date(data.date).toLocaleDateString('id-ID', {day:'numeric', month:'long', year:'numeric'}) : '...'}</div>
                <div className="font-bold text-lg">{data.receiverName}</div>
            ...
            <div className="space-y-4 text-justify text-slate-700 text-sm flex-grow">
