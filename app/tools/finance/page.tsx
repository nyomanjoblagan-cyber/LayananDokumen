 ...
 * STATUS: FULL PRODUCTION VERSION
 * FEATURES: 
 * - Invoice (2 Templates), Nota (2 Templates), Kuitansi (2 Templates)
 * - Mobile Responsive (Editor/Preview Toggle)
 * - Print Optimization (Anti-Shadow/Gray Background)
 */
...
function FinanceToolBuilder() {
  ...
  const DocumentContent = () => (
    /* ANTI SHADOW FIX: print:shadow-none print:border-none */
    <div className="bg-white print:shadow-none print:border-none shadow-2xl mx-auto overflow-hidden relative border border-slate-200" style={{ width: dims.w, minHeight: dims.h }}>
          ...
          <div className="h-full flex flex-col text-[#1e293b] p-[10mm] md:p-[15mm]">
            {templateId === 1 && (
              <>
                ...
                {/* ANTI GRAY BG FIX: print:bg-white */}
        ...
        <div className="h-full flex flex-col p-[5mm] md:p-[8mm]">
          ...
          {templateId === 2 && (
              <div className="h-full flex flex-col">
                ...
                <div className="bg-slate-100 print:bg-white p-2 rounded mb-4 space-y-1 text-[10px]">
                ...
                <table className="w-full mb-4 text-[10px]">
                    <thead className="bg-blue-600 text-white print:text-black print:bg-transparent print:border-b-2 print:border-black">
                ...
                <div className="mt-auto">
                    <div className="flex justify-end mb-4">
                      <div className="bg-blue-50 print:bg-white border border-blue-200 px-4 py-2 rounded text-right">
                          <span className="text-xs font-bold text-blue-800">TOTAL: Rp {total.toLocaleString('id-ID')}</span>
                      </div>
                    </div>
                    <div className="bg-blue-600 print:bg-white print:text-black print:border-t print:border-black text-center py-1 text-[9px] rounded-b font-medium text-white">Terima kasih atas kepercayaan Anda!</div>
                </div>
              </div>
          )}
        </div>
      ...
      {activeDocType === 'kuitansi' && (
        <div className="h-full flex flex-col justify-center">
              ...
              <div className="h-full flex flex-row p-0 overflow-hidden">
                ...
                <div className="flex-1 flex flex-col justify-between p-4 md:p-6 bg-[#fdfaf6] print:bg-white">
                    ...
                    <div className="flex justify-between items-end mt-4">
                      <div className="bg-[#c2410c] print:bg-transparent print:text-black print:border-2 print:border-black text-white px-4 md:px-6 py-2 font-bold text-base md:text-lg rounded-tl-xl rounded-br-xl shadow-md">
          ...
          {templateId === 2 && (
              <div className="h-full border-2 border-emerald-800 p-1 bg-[#f0fff4] print:bg-white text-emerald-900 absolute inset-0 m-0 box-border">
                <div className="h-full border border-emerald-600 p-6 flex flex-col justify-between relative">
                    ...
                    <div className="space-y-2 font-serif relative z-10 text-emerald-950 text-sm">
                      ...
                      <div className="flex items-end"><span className="w-32">Banyaknya uang :</span><div className="flex-1 border-b border-dotted border-emerald-800 bg-emerald-100/50 print:bg-white px-2 font-bold italic capitalize"># {terbilangText} #</div></div>
  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] font-sans text-slate-800">
      ...
      <div className="max-w-[1600px] mx-auto p-4 md:p-6 flex flex-col md:flex-row gap-6 items-start h-[calc(100vh-64px)] overflow-hidden relative">
        ...
        {/* LEFT SIDEBAR: INPUT (DENGAN MOBILE SLIDE LOGIC) */}
        ...
        {/* RIGHT PREVIEW (DENGAN MOBILE TRANSFORM LOGIC) */}
