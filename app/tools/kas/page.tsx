...
import { 
  ...
  Wallet, TrendingUp, ChevronDown, Check, Edit3, Eye
} from 'lucide-react';
...
function CashToolBuilder() {
  ...
  const TEMPLATES = [
    { id: 1, name: "Tabel Akuntansi (Klasik)", desc: "Kolom Debet/Kredit terpisah" },
    { id: 2, name: "Mutasi Modern (Statement)", desc: "Gaya rekening koran bersih" }
  ];
