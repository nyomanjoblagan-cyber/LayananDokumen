...
function BedaNamaBuilder() {
  ...
  const activeTemplateName = templateId === 1 ? 'Standar Notaris (Legal)' : 'Corporate (Clean)';
  ...
  const ContentInside = () => {
    return (
      <div className={`text-black leading-[1.6] ${templateId === 1 ? 'font-serif text-[11pt]' : 'font-sans text-[10pt]'}`}>
