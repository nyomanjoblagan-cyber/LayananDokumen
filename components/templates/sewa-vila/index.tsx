        ...
        <div className={`no-print ${mobileView === 'editor' ? 'flex' : 'hidden'} md:flex w-full md:w-[450px] lg:w-[500px] flex-col bg-white border-r border-slate-200 shadow-xl z-10 h-full`}>
          <div className="p-5 border-b border-slate-200 bg-white sticky top-0 z-20">
            <div className="flex justify-between items-center mb-3">
              <div>
                <h2 className="text-lg font-bold text-slate-800">Sewa Vila / Leasehold</h2>
                <p className="text-xs text-slate-500">Kontrak Sewa Jangka Panjang B2B</p>
              </div>
            ...
            <div className="bg-amber-50 border-l-4 border-amber-500 p-3 rounded-r-lg">
               <p className="text-[10px] font-bold text-amber-700 leading-tight">PREMIUM PROTECTION:</p>
               <p className="text-[10px] text-amber-700 leading-tight mt-1">Template ini telah dilengkapi klausul <b>Anti-Airbnb/Sub-lease</b> dan proteksi sengketa deportasi WNA untuk mengamankan aset miliaran Anda.</p>
            </div>
          </div>
          ...
          <div className="flex-1 overflow-y-auto p-5 custom-scrollbar pb-24 md:pb-5">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-sm text-slate-800 border-b pb-2">Data Pemilik (Pihak 1)</h3>
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-sm text-slate-800 border-b pb-2">Data Penyewa (Pihak 2)</h3>
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-sm text-slate-800 border-b pb-2">Detail Properti & Waktu Sewa</h3>
              ...
              <div className="space-y-4">
                <h3 className="font-bold text-sm text-slate-800 border-b pb-2">Harga & Metode Pembayaran</h3>
