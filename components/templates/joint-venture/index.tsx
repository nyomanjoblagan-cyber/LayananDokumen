    ...
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-800">
      ...
      <main className="flex-grow flex flex-col md:flex-row overflow-hidden h-[calc(100vh-64px)] print:block print:h-auto print:overflow-visible">
         ...
         <div className={`no-print w-full md:w-[480px] lg:w-[500px] bg-slate-50 border-r border-slate-200 flex flex-col h-full z-10 transition-transform duration-300 absolute md:relative shadow-xl md:shadow-none ${activeTab === 'preview' ? '-translate-x-full print:translate-x-0 md:translate-x-0' : 'translate-x-0'}`}>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 pb-32 md:pb-10 custom-scrollbar font-sans bg-slate-50/50 print:hidden print:overflow-visible print:bg-white">
              ...
              <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5 space-y-5 relative overflow-hidden group">
                 ...
                 <div className="space-y-2">
                    ...
                    <div className="flex items-center gap-3">
                       <div className="flex-1 flex items-center border rounded-lg overflow-hidden bg-white shadow-sm print:hidden print:overflow-visible print:bg-white">
                 ...
                 <div className="space-y-2 pt-2">
                    ...
                    <div className="flex items-center gap-3">
                       <div className="flex-1 flex items-center border border-rose-200 rounded-lg overflow-hidden bg-white shadow-sm print:hidden print:overflow-visible print:bg-white">
         ...
         <div className={`no-print flex-1 bg-slate-200/60 relative overflow-hidden flex flex-col items-center ${activeTab === 'editor' ? 'hidden md:flex' : 'flex'} print:hidden print:overflow-visible print:bg-white print:static`}>
