...
function SuratDinasBuilder() {
 ...
 <div className={`flex-1 bg-slate-200/50 overflow-y-auto h-full flex flex-col relative ${mobileView === 'editor' ? 'hidden md:flex' : 'flex'} print:flex print:overflow-visible print:bg-white print:static`}>
 ...
 <div className="flex-1 p-4 md:p-8 overflow-y-auto custom-scrollbar flex justify-center pb-32 print:flex print:overflow-visible print:bg-white">
