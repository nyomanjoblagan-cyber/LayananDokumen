  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900">
      ...
      <main className="flex-grow flex flex-col md:flex-row overflow-hidden h-[calc(100vh-64px)]">
        ...
        <div className={`flex-1 bg-slate-200/50 overflow-y-auto h-full flex flex-col relative ${mobileView === 'editor' ? 'hidden md:flex' : 'flex'}`}>
            ...
            <div className="flex-1 p-4 md:p-8 overflow-y-auto custom-scrollbar flex justify-center pb-32">
