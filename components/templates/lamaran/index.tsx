...
function CoverLetterBuilder() {
  ...
  const LetterContent = () => {
    ...
    return (
      <div className="bg-white flex flex-col box-border font-serif text-slate-900 leading-normal text-[11pt] w-[210mm] print:w-full print:min-w-0 min-h-[296mm] print:min-h-0 p-[20mm] print:p-0 shadow-2xl print:shadow-none print:m-0 mx-auto">
        {templateId === 1 && (
