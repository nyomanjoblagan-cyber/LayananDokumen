...
function VisaSponsorBuilder() {
  ...
  const DocumentContent = () => {
    ...
    return (
      <div className={`bg-white flex flex-col box-border text-black leading-normal p-[15mm] md:p-[20mm] print:p-0 w-[210mm] print:w-full print:min-w-0 min-h-[296mm] print:min-h-0 shadow-[0_20px_50px_rgba(0,0,0,0.1)] print:shadow-none print:m-0 mx-auto font-serif text-[11pt] relative overflow-hidden`}>
        ...
        {templateId === 1 && (
          <div className="absolute inset-0 flex justify-center items-center   print:opacity-[0.05] z-0">
  ...
  return (
    <div className="min-h-screen bg-[#0f172a] flex flex-col font-sans text-slate-200">
      ...
      <main className="flex-grow flex flex-col md:flex-row overflow-hidden h-[calc(100vh-64px)] print:block print:h-auto print:overflow-visible relative">
        ...
        {/* BACKGROUND ACCENT */}
        <div className="absolute top-0 right-0 w-[50vw] h-[50vw] bg-emerald-900/10 rounded-full blur-[120px]  no-print"></div>
        <div className="absolute bottom-0 left-0 w-[40vw] h-[40vw] bg-blue-900/10 rounded-full blur-[100px]  no-print"></div>
 ...
 <div className="flex-1 overflow-y-auto p-5 space-y-6 custom-scrollbar pb-32 print:flex print:overflow-visible print:bg-white">
        ...
        {/* PREVIEW AREA */}
 <div className={`flex-1 h-full flex flex-col items-center p-4 md:p-8 overflow-y-auto relative ${mobileView === 'editor' ? 'hidden md:flex' : 'flex'} print:flex print:overflow-visible print:bg-white print:static z-20`}>
