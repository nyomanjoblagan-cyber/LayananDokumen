    ...
    return (
        <div className={`bg-white mx-auto flex flex-col box-border font-sans text-slate-900 leading-snug`}>
            ...
            <div className="bg-slate-50 p-4 rounded-lg border border-slate-100">
              <table className="w-full text-[10px]">
                <tbody className="divide-y divide-slate-200">
                  ...
                  <tr><td className="py-1.5 text-slate-500 font-bold uppercase tracking-tighter">Jatuh Tempo</td><td className="text-right font-bold text-red-600">{formatDateSafe(data.dueDate)}</td></tr>
          ...
          <div className="flex-grow">
            <table className="w-full mb-8 border-collapse">
              ...
              <tbody className="divide-y divide-slate-200 border-b-2 border-slate-900">
                {data.items.map((item, idx) => (
                  <tr key={idx} className="text-[11px] break-inside-avoid" style={{ pageBreakInside: 'avoid' }}>
            ...
            {/* TOTALS */}
            <div className="flex justify-end mb-12 break-inside-avoid" style={{ pageBreakInside: 'avoid' }}>
              <div className="w-72">
          ...
          {/* FOOTER */}
          <div className="shrink-0 grid grid-cols-2 gap-10 items-end break-inside-avoid" style={{ pageBreakInside: 'avoid' }}>
            <div>
            ...
            <div className="text-center">
              <p className="text-[10px] mb-16 uppercase tracking-widest text-slate-500">{data.city}, {formatDateSafe(data.date)}</p>
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-8 pb-32 md:pb-10 custom-scrollbar">
               ...
               <div className="space-y-3">
                  ...
                  <div className="bg-white p-4 rounded-2xl border border-slate-200 shadow-sm space-y-3">
                      ...
                      <div className="space-y-1"><label className="text-[10px] font-bold text-slate-500">Tgl Jatuh Tempo</label><input type="date" className="w-full px-3 py-2 border border-slate-200 rounded-lg text-xs focus:ring-2 focus:ring-emerald-500 outline-none" value={data.dueDate} onChange={e => handleDataChange('dueDate', e.target.value)} /></div>
                  </div>
               </div>
