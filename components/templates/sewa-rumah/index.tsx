...
function RentalAgreementBuilder() {
  ...
  const A4Document = ({ children }: { children: React.ReactNode }) => (
    <div className="bg-white block box-border text-black leading-normal p-[20mm] w-[210mm] min-h-[297mm] h-auto shadow-2xl print:shadow-none print:m-0 print:h-auto print:w-[210mm] print:p-0 relative mb-10 print:mb-0">
      {children}
    </div>
  );
