 ...
 * FIX: Mobile Menu Template Selection Now Visible & Monetization Injected
 */
...
function DrugTestBuilder() {
  ...
  // --- HANDLERS ---
  const handleDataChange = (field: keyof LabData, val: string) => {
      ...
      return (
        <div className="font-serif text-[10.5pt] leading-snug text-black">
           ...
           <div className="space-y-4 flex-grow">
              ...
              <div className="ml-4 space-y-1 font-sans text-sm border-l-2 border-slate-300 pl-4 break-inside-avoid">
           ...
           {/* TANDA TANGAN */}
           <div className="shrink-0 mt-10 flex justify-between items-end break-inside-avoid" style={{ pageBreakInside: 'avoid' }}>
      ...
      return (
        <div className="font-sans text-[10.5pt] text-black leading-snug">
           ...
           <div className="mb-6">
              ...
              <div className="bg-slate-50 p-5 rounded-xl border border-slate-300 mb-6 break-inside-avoid">
              ...
              <p className="mb-4 break-inside-avoid">Telah dilakukan pemeriksaan fisik dan laboratorium urin (Screening Test 6 Parameter) pada tanggal {formatDate(data.date)} dengan hasil sebagai berikut:</p>

              <div className="grid grid-cols-2 gap-x-8 gap-y-2 mb-6 break-inside-avoid">
                 {data.results.map((r, i) => (
              ...
              <div className="bg-emerald-50 border-2 border-emerald-100 p-4 rounded-lg text-center mb-6 break-inside-avoid">
              ...
              <p className="text-justify break-inside-avoid">Demikian surat keterangan ini dibuat dengan sebenar-benarnya untuk dipergunakan sebagai: <b>{data.purpose}</b>.</p>
           </div>
