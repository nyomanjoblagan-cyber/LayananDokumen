  ...
  return (
    <div className="min-h-screen bg-[#f3f4f6] font-sans text-slate-800">
      ...
      <main className="max-w-[1600px] mx-auto p-4 md:p-6 flex flex-col md:flex-row gap-6 h-[calc(100vh-64px)] overflow-hidden relative">
        ...
        {/* PREVIEW AREA */}
        <div className={`flex-1 h-full bg-slate-200/80 rounded-xl flex flex-col items-center p-4 md:p-8 overflow-y-auto relative ${mobileMode === 'editor' ? 'hidden md:flex' : 'flex'} custom-scrollbar`}>
          <div className="origin-top transition-transform duration-300 transform scale-[0.35] sm:scale-[0.55] md:scale-[0.7] lg:scale-[0.85] xl:scale-100 mb-[-150%] sm:mb-[-100mm] md:mb-[-40mm] lg:mb-[-10mm] xl:mb-10 mt-2 xl:mt-0 shadow-2xl shrink-0">
             <DocumentContent />
          </div>
        </div>
      </main>
