...
function FinanceToolBuilder() {
 ...
 <div className="flex-1 overflow-y-auto p-4 space-y-6 custom-scrollbar pb-32 md:pb-10 print:flex print:overflow-visible print:bg-white">
        ...
        {/* PREVIEW AREA */}
 <div className={`flex-1 h-full bg-slate-200/80 rounded-xl flex flex-col items-center p-4 md:p-8 overflow-y-auto relative ${mobileMode === 'editor' ? 'hidden md:flex' : 'flex'} custom-scrollbar print:flex print:overflow-visible print:bg-white print:static`}>
