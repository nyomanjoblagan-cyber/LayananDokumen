...
function BastBuilder() {
  ...
  const Kertas = ({ children, className = '' }: { children: React.ReactNode, className?: string }) => (
    <div className={`bg-white shadow-2xl print:shadow-none mx-auto p-[20mm] print:p-0 text-slate-900 ${templateId === 1 ? 'font-serif text-[11pt]' : 'font-sans text-[10pt]'} leading-relaxed relative box-border mb-8 print:mb-0 print:m-0 w-[210mm] print:w-full print:min-w-0 min-h-[296mm] print:min-h-0 h-auto ${className}`}>
      {children}
    </div>
  );
          ...
          <Kertas className="print:w-full print:min-w-0">
              ...
              <div className="text-justify mb-8">
                <ol className="list-decimal pl-6 space-y-2">
                  ...
                  <li>PIHAK KEDUA dilarang untuk memindah-tangankan, menyewakan kembali (sub-lease), dan/atau mengalihkan hak penguasaan atas Objek Serah Terima kepada pihak ketiga manapun tanpa persetujuan tertulis sebelumnya dari PIHAK PERTAMA.</li>
                </ol>
              </div>
 ...
 <div className={`flex-1 bg-slate-200 overflow-y-auto relative transition-transform ${mobileView === 'editor' ? 'translate-x-full print:translate-x-0 md:translate-x-0 hidden md:block' : 'translate-x-0 block'} md:block print:flex print:overflow-visible print:bg-white print:static`}>
          ...
          <div className="p-4 md:p-8 min-h-full flex flex-col items-center justify-start print:hidden">
