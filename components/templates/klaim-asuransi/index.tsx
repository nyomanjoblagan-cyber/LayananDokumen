...
function InsuranceClaimBuilder() {
  ...
  const ClaimContent = () => {
    ...
    return (
      <div className="bg-white flex flex-col box-border font-serif text-slate-900 leading-snug text-[10pt] w-[210mm] print:w-full print:min-w-0 min-h-[296mm] print:min-h-0 p-[20mm] print:p-0 shadow-2xl print:shadow-none print:m-0 mx-auto">
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col font-sans text-slate-900">
      ...
      <div id="print-only-root" className="hidden print:h-auto print:static"><div className="bg-white"><ClaimContent /></div></div>
    </div>
  );
}