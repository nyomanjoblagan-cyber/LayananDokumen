...
function PartnerConsentBuilder() {
 ...
 <div className="flex-1 overflow-y-auto p-5 space-y-8 custom-scrollbar pb-32 print:overflow-visible print:bg-white">
        ...
        {/* PREVIEW */}
 <div className={`flex-1 h-full bg-slate-200/60 flex flex-col items-center p-4 md:p-8 overflow-y-auto relative custom-scrollbar ${mobileView === 'editor' ? 'hidden md:flex' : 'flex'} print:overflow-visible print:bg-white print:static print:p-0`}>
